...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        this.botao = findViewById<Button>(R.id.btMainNavegacao)
        this.botao.setOnClickListener({ onClick(it) })

        Log.i("APP_VV", "Main passou por onCreate")
    }

    fun onClick(view : View) {
        Log.i("APP_VV", "Clicou no botao Vai")
        val mensagem = "Funcionou pirraia"
    ...
    override fun onStart() {
        super.onStart()
        Log.i("APP_VV", "Main passou por onStart")
    }
}
